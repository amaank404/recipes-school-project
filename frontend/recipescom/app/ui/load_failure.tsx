...
export default function LoadFailure({err, className, nobackbutton}: {err?: string, className?: string, nobackbutton?: boolean}) {
    return <div className={className || "h-screen w-screen absolute top-0 left-0"}>
